    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          _DrawerTile(icon: Icons.menu_book, label: 'Syllabus', onTap: () => _navigate(context, '/coordinator/syllabus')),
          _DrawerTile(icon: Icons.school, label: 'Homework', onTap: () => _navigate(context, '/coordinator/homework')),          _DrawerTile(icon: Icons.settings, label: 'Settings', onTap: () => _navigate(context, '/coordinator/settings')),          const Divider(),
