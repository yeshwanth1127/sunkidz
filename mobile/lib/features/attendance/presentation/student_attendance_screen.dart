...
class _StudentAttendanceScreenState extends State<StudentAttendanceScreen> {
  final _students = [
    ...
    _StudentAtt(
      ...
      status: 'leave',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuCeHBDFwYwWUWdB0s0vfbqcRq6Mjt7QY2Zdlaw3QUycN_hFlJrulW3QC0vTRx0GN7enH0uEEnKzU8EJuyvdb4JFgkvnJzriNCnYtUPda81UcNjip7YAJTO4za88VfV5V_tB_eaG3fnhoqHFBTlG7vaK6ficW4GpSu-hr_cKpdQy1IKET_Ae5QsAwaDhQoxjecjk74_AKdPxBcRSwcjgB88VM1a830kB0ZeHFl66KnD7D_dL_JXF7_MLbGqQyGqYPYmHgxfmr2FNI6E',
    ),
    _StudentAtt(
      name: 'Emma Sophia',
      rollNo: '04',
      status: 'present',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuBV7psrkQROj8bzrKAOcaSuRjHOZacM8r1F9m-Tp0TVpFeccjZep1KZZXDJlhO79zpM4Rpv_FgrK78rN3hmNp3-h-s7taombsyi_3tvjortA9hzWN8DNsAaoAsDRReHcsBvvGoUVlV7us7we58RHtU-9XCKCRt3GHfr8wMXUVnC1jo41pCFFI9tQAZ0p-OK3m-q6R-Lq3axEDWO0NVGEYfIpXAHusLSdTHZrzx8QOJy-3XZ9q8jdmA61mwqnv5rGAS6dzaQRdB5zTo',
    ),
    _StudentAtt(
      name: 'Ethan James (On Leave)',
      rollNo: '05',
      status: 'leave',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuCEfZXwEpdQtbyNqG2FrVQMan4MF3G6TQc_z7HpUClxkjZYay9dOH9ziHh5fz3zi13QFgNZVzwktFIRI1FrfVWt10Y-9dKZb3R4IPQMmz-1y3BX_mMPfBDRJDqAXguD0a0q0ijFXoVF6DLEXVXwMdU8loRXQ6-Y7PIlyHLZdlnrEvHrpxHnm97mVWyx5zZqSYuyTlSiER9QSrVJlGGDxqqIz5DpUWCGih0_0c93ly22ERFOaWdvjIuLl2D4p8QXqXSpZRmsJoutByE',
    ),
  ];
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'Last updated 5 mins ago by Ms. Sarah',
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                    color: student.status == 'leave' ? Colors.grey : null,
                  ),
                ),
                Text(
                  'Roll #${student.rollNo}',
